              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <Center><h1 class="box-title">PRESTAMO y DEVOLUCION </h1></Center>
                        <div >
                        </div>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <center><button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Prestar libro</button></center>
                    <div class="panel-body" id="formularioregistros">
                       <form name="formulario" id="formulario" method="POST">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              ...
                              <input type="date" name="fecha_devolucion" id="fecha_devolucion" max="fecha_prestamo" class="form-control" placeholder="Fecha Devolución" required>
                        </div>

                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              <label>Cantidad:</label>
                              <input type="number" min="1" max="3" pattern="^[0-9]+" name="cantidad" id="cantidad" class="form-control" required>
                        </div>
