...
Class Autor
{
	...
	{
		$sql="INSERT INTO autor (nombre,descripcion,condicion)
		VALUES ('$nombre','$descripcion','1')";
		return ejecutarConsulta($sql);
	}

	//Implementamos un método para editar registros
	public function editar($idautor,$nombre,$descripcion)
	{
		$sql="UPDATE autor SET nombre='$nombre',descripcion='$descripcion' WHERE idautor='$idautor'";
		return ejecutarConsulta($sql);
	}
